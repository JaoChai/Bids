<div class="content_container">
 <div class="bidnow_row">
    <div class="content_middlebg" style="padding-top:0px;">
    	<div class="myaccount_container">
        	<div class="myaccount_left_menu_container">
    <div class="myaccount_left_menu_heading">
        <div class="myaccount_left_menu_header_leftbg">&nbsp;</div>
        <div class="myaccount_left_menu_header_middlebg">ส่วนสมาชิก</div>
        <div class="myaccount_left_menu_header_rightbg">&nbsp;</div>
    </div>
        <div class="myaccount_left_menu_leftbg">&nbsp;</div>
    <div class="myaccount_left_menu_middlebg">
    	        <div class="myaccount_left_menu_box">
            <div class="myaccount_left_menu_inner_box">
                <div class="myaccount_left_menu_inner_leftbg">&nbsp;</div>
            ...
            <div class="myaccount_left_menu_inner_sec_box">
                ...
                <div class="myaccount_left_menu_inner_sec_textselected"><a href="#">สรุป</a></div>
            </div>
        </div>
        <div class="myaccount_left_menu_box">
            <div class="myaccount_left_menu_inner_box">
                <div class="myaccount_left_menu_inner_leftbg">&nbsp;</div>
                <div class="myaccount_left_menu_inner_middlebg">
                    <div class="myaccount_left_menu_inner_title">My BidCups</div>
                    <div class="myaccount_left_menu_inner_arrow">&nbsp;</div>
                </div>
                <div class="myaccount_left_menu_inner_rightbg">&nbsp;</div>
            </div>
            <div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_mexnu_inner_sec_text"><a href="#">สินค้าที่คุณสนใจ</a></div>
            </div>
            <div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">Watchlist</a></div>
            </div>
            <div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">Bidsaurus</a></div>
            </div>
			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">ซื้อ Bid</a></div>
            </div>
        </div>
		...
		<div class="myaccount_left_menu_box">
            <div class="myaccount_left_menu_inner_box">
                <div class="myaccount_left_menu_inner_leftbg">&nbsp;</div>
                <div class="myaccount_left_menu_inner_middlebg">
                    <div class="myaccount_left_menu_inner_title">History</div>
                    <div class="myaccount_left_menu_inner_arrow">&nbsp;</div>
                </div>
                <div class="myaccount_left_menu_inner_rightbg">&nbsp;</div>
            </div>
            <div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">สินค้าที่ชนะ</a></div>
            </div>
			            <div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">สินค้าที่สั่งซื้อ</a></div>
            </div>
            			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">สินค้าสั่งซื้อผ่าน Shop</a></div>
            </div>

			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">สินค้าที่ปิดประมูลแล้ว</a></div>
            </div>
			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#"> สินค้าที่คุณแลกรีวอร์ดส</a></div>
            </div>
			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">ประวัติการ Bid</a> </div>
            </div>
			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">D-Points ใกล้หมดอายุ</a> </div>
            </div>
			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">Limit การ Bid</a> </div>
            </div>
			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">คูปองโปรโมชั่น</a></div>
            </div>
        </div>
        <div class="myaccount_left_menu_box">
            <div class="myaccount_left_menu_inner_box">
                <div class="myaccount_left_menu_inner_leftbg">&nbsp;</div>
                    <div class="myaccount_left_menu_inner_middlebg">
                        <div class="myaccount_left_menu_inner_title">My Account</div>
                        <div class="myaccount_left_menu_inner_arrow">&nbsp;</div>
                    </div>
                <div class="myaccount_left_menu_inner_rightbg">&nbsp;</div>
            </div>
			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">รายละเอียดแอคเคาน์</a></div>
            </div>
            <div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
            ...
            <div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">แนะนำเพื่อนฝูง</a></div>
            </div>
			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">จดหมายแจ้งข่าว</a></div>
            </div>
			<div class="myaccount_left_menu_inner_sec_box">
                <div class="myaccount_left_menu_arrow">&nbsp;</div>
                <div class="myaccount_left_menu_inner_sec_text"><a href="#">ปิดบัญชี</a> </div>
            </div>
        </div>
    </div>
        <div class="myaccount_left_menu_rightbg">&nbsp;</div>
    </div>
