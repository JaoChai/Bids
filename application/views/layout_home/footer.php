            ...
            <div class='collapsed-content'>
              <ul class='marker-list'>
                <?php foreach($about as $row): ?>
                  <li><a href='<?php echo site_url('home/viewcontent/'. $row->menu_title);?>'><?php echo $row->menu_name;?></a></li>
                <?php endforeach; ?>
              </ul></div>
            </div>
          </div>
            ...
            <div class="footer-block  collapsed-mobile">
              ...
              <div class='collapsed-content'>
                <ul class='simple-list'>
                  <li><i class='icon icon-phone'></i><?php echo $result->general_tel;?></li>
                  <li><i class='icon icon-close-envelope'></i><?php echo $result->general_email;?></li>
          ...
          <div class="container">
            <div class="row">
              <div class=" col-md-12 col-lg-12">
                <div class="footer-copyright text-center"> <?php echo $result->general_footer;?> </div>
